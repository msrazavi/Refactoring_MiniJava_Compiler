...
//    }
    ...
    public void call() {
        ...
        ss.push(temp);
        memory.add3AddressCode(Operation.ASSIGN, new Address(temp.num, varType.Address, new ImmediateAddressType()), new Address(symbolTable.getMethodReturnAddress(className, methodName), varType.Address), null);
