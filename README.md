...
13. بازآرایی‌های جزئی نهایی: در نهایت موارد ریز مثل حذف کامنت‌ها و ریفکتورهای پیشنهادی IDE و ... را انجام می‌دهیم. نکته مهم اینکه بعد از هر یک از موارد بالا کد را اجرا می‌کنیم و مطمئن می‌شویم بازآرایی موجب خطایی در بیلد و اجرای پروژه نشده و خروجی هم همچنان ثابت است. البته این مورد نیازبه تست‌های جزئی‌تر دارد و شاید همه موارد در یک بیلد و اجرا مشخص نشوند ولی همین هم کمک شایانی به اطمینان از ریفکتور صحیح می‌کند. 
![image](https://github.com/msrazavi/Refactoring_MiniJava_Compiler/assets/24840082/a338a899-0362-4f19-94d5-b57e2e403461)
